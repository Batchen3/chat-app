...
if [[ "$push_to_gcp" == "Y" ]]; then
    ...
    docker tag ${img_name_and_tag} me-west1-docker.pkg.dev/grunitech-mid-project/batchen-chat-app-images/chat-app:${version}
    docker push me-west1-docker.pkg.dev/grunitech-mid-project/batchen-chat-app-images/chat-app:${version}
